...
var CKOHelper = {
     ...
     */
    getOrderId: function() {
        var orderId = (this.getValue('cko3ds')) ? request.httpParameterMap.get('udf1').stringValue : request.httpParameterMap.get('trackId').stringValue;
        if (orderId === null) {
    ...
    paymentIsValid: function(gResponse) {
    	...
    	if(gResponse.hasOwnProperty('responseCode')){
    		return gResponse.response_code == "10000" || gResponse.response_code == '10100' || gResponse.response_code == '10200';
    	}else if(gResponse.hasOwnProperty('actions')){
    		return gResponse.actions[0].response_code == '10000' || gResponse.actions[0].response_code == '10100' || gResponse.actions[0].response_code == '10200';
    	}
    },   
